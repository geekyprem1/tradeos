CREATE TABLE profiles (
  ...
  market_type           TEXT DEFAULT 'equity' CHECK (market_type IN ('equity','fo','crypto','commodity')),
  trading_style         TEXT DEFAULT 'intraday' CHECK (trading_style IN ('scalping','intraday','swing')),
